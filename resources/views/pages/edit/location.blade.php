...
<div> 
       ...
       <form action="/edit/editLocation/{{$members->id}}" method="post">
        {{csrf_field()}}
               ...
               <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Hometown" name="home_name" value="{{$members->hometowm}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                   ...
                   <!-- residential address -->
                   <div class="form-group">
                       <input type="text" class="form-control" placeholder="Residential Address/ Digital Address" name="residence" value="{{$members->residence}}">
                   </div>

                   <!-- contact -->
                   <div class="form-group">
                       <input type="text" class="form-control" placeholder="Contact/Phone/Mobile Number" name="phone" value="{{$members->contact}}">
                   </div>
                   ...
                   <div class="form-group gender">
                    ...
                    <div class="form-group" id="spouse-name">
                        <input type="text" placeholder="Name of Spouse" class="form-control" name="spouse_name" value="{{$members->spouse_name}}">
                    </div>

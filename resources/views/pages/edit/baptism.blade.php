...
@section('left-pane')
 ...
 @endsection
  ...
  <div> 
       ...
       <form action="/editBap/{{$members->id}}" method="post">
        {{csrf_field()}}
           <div class="row form-layout">
             ...
             <label style="margin-top: 20px; font-weight: bold">Baptismal Information</label>
                   ...
                   <div class="form-group" style="margin-top: -20px;">
                       <input type="text" class="form-control"  placeholder="Place of Baptism" name="bap_place" value="{{$members->place_of_baptism}}">
                   </div>


                   <!-- method of baptism -->
                    <div class="form-group">
                            <select name="home_region" id="baptismselection" class="form-control" name="method_bap">
                    ...
                    <div class="form-group" style="margin-top: -30px;">
                       	<input type="text" class="form-control" id="otherBaptism" placeholder="Other Method of Baptism" name="other_bap" value="{{$members->other_method}}">
                   	</div>
                  ...
                  <div class="form-group" style="margin-top: -30px;">
                    ...
                    <div class="form-group" style="margin-top: 0px;">
                       <input type="text" class="form-control" id="other_role" placeholder="Other Role" name="other_role" value="{{$members->other_role}}">
                   </div> 

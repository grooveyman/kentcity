       ...
       <form action="{{route('addFirst')}}" method="post">
        {{csrf_field()}}
           <div class="row form-layout">
               ...
               <div class="col-md-6">
                @if(session('fail'))
                <div class="alert alert-danger"><p>{{session('fail')}}</p></div>
                @endif
               <div>
               ...
               <!-- surname -->
                   <div class="form-group">
                       <input type="text" class="form-control" placeholder="Surname" name="surname" style="text-transform:uppercase" required>
                   </div>
                   ...
                   <!-- othernames -->
                   <div class="form-group">
                       <input type="text" class="form-control" placeholder="Othernames" name="oname">
                   </div>

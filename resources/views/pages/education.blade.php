...
@section('left-pane')
 ...
 <div> 
       ...
       <form action="/addEdu/{{$members->id}}" method="post">
        {{csrf_field()}}
           <div class="row form-layout">
               ...
               <!-- surname -->
                   ...
                   <div class="form-group" id="other">
                       <input type="text" class="form-control"  placeholder="Other Educational Level" name="other_education">
                   </div>
                   ...
                   <div class="row" style="margin-top: -20px">
                    ...
                    <div class="form-group" style="margin-top: -30px;">
                       <input type="text" class="form-control" id="father_contact" placeholder="Father's Contact" name="father_phone">
                   </div> 
                   ...
                   <!-- mother -->
                    ...
                    <div class="form-group" style="margin-top: -10px;">
                       <input type="text" class="form-control" id="mother_contact" placeholder="Mother's Contact" name="mother_phone">
                   </div> 
